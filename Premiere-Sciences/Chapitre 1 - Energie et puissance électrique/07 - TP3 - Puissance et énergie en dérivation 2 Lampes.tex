...
\fcolorbox{black}{blue!30}{\textbf{2. Protocole}} 

Proposer un schéma électrique permettant  : d'alimenter deux lampes, de mesurer la tension en V aux bornes de celle-ci ainsi que  de mesurer l’intensité en A délivrée par le générateur. \\ 
On utilisera les symboles suivants : \\
\vspace{-5mm}
\begin{center} 
\includegraphics[scale=0.5]{Chapitre 1 - Energie et puissance électrique/images/instruments.png}
\end{center}
\vspace{-2mm}
\cadreblanc{40}
...
\includegraphics[width=\textwidth]{Chapitre 1 - Energie et puissance électrique/images/TP1 - Montage.jpg}\end{center}
\end{minipage}%

\begin{enumerate}[label=3.\arabic*]

     \item  Réaliser le montage électrique ci-dessus avec la lampe L1.
...
\begin{multicols}{2}
   ...
   \item  Réglez le joulemètre en mode puissance et relevez la valeur de la puissance $\mathrm{P_1}$ reçue par la lampe 1 allumée. \\
    ...
    \columnbreak
     ...
     \item Réglez le joulemètre en mode puissance et relevez la valeur de la puissance $\mathrm{P_2}$ reçue la lampe 2 allumée. \\
...
\begin{minipage}{14cm}{
 ...
 Appeler M Ruiz et proposer à l'oral un montage pour mesurer la puissance reçue \textbf{par les deux lampes montées en dérivation}.}
...
\vfill 
     ...
     \item  Réglez le joulemètre en mode puissance et relevez la valeur de la puissance $\mathrm{P}$ reçue par les 2 lampe allumée. \\
   ...
   \item Réglez le joulemètre en mode énergie et relevez la valeur de l'énergie $E$ reçue par les deux lampes allumés pour des durées $t$ égales à 60s, 120s, 180s et 240s. \\ Noter les valeurs dans le tableau ci-dessous. 
...
%papier milli
\draw [very thin, gray!20] (0,-3) grid[step=0.1] (13,8);

\draw [very thin, black!20] (0,-3) grid[step=0.5] (13,8);
\draw [very thin, black!40] (0,-3) grid[step=1] (13,8);
\draw[->,>=stealth] (0,-3) -- (13.5,-3) node[below right] {t(ms)};
%stealth définit un style de flèche, "furtif"
\draw[->,>=stealth] (0,-3) -- (0,8.2)node[below left] {E(J)};

\draw (0,-2.9) -- (0,-3.1) node [below left] {{\scriptsize 0}}; 
\draw (3,-2.9) -- (3,-3.1) node [below left] {{\scriptsize 60}}; %échelle abscisse
\draw (0.1,-2) -- (-0.1,-2) node [left] {{\scriptsize 
...
4.1.  Calculer, en Watt, la puissance reçue par la lampe. On utilisera les valeurs de l'énergie E, en J, mesurée pour t = 240 s\\
\cadreblanc{15}
4.2.  Cette valeur est-elle en accord avec celle mesurée à à la question 3.4. ? \\
\cadreblanc{10}
4.3.  Proposer une relation liant \textbf{E, l'énergie totale} reçue par les deux lampes lampe ; \textbf{$\mathrm{E_1}$, l'énergie } reçue par la lampe 1 et \textbf{$\mathrm{E_2}$, l'énergie}  reçue par la lampe 2.   \\
\cadreblanc{10}
