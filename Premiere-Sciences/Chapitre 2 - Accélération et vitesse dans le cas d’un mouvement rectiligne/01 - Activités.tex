...
\includegraphics[width=\textwidth]{Chapitre 2 - Accélération et vitesse dans le cas d’un mouvement rectiligne/images/doc1.png}
\end{minipage}%
...
ex}{\includegraphics[scale=0.45]{Chapitre 2 - Accélération et vitesse dans le cas d’un mouvement rectiligne/images/doc2.png}}}
\vspace{1mm}
...
\includegraphics[width=\textwidth]{Chapitre 2 - Accélération et vitesse dans le cas d’un mouvement rectiligne/images/doc3.png}
\end{minipage}%

  \awesomebox[black]{1pt}{\faCogs}{black}{Chute d'une plume et d'une boule de bowling dans une chambre à vide \raisebox{-3.2
ex}{\includegraphics[scale=0.25]{Chapitre 2 - Accélération et vitesse dans le cas d’un mouvement rectiligne/images/doc4.png}}}
...
\hfill
\begin{minipage}{.45\textwidth}%
\includegraphics[width=\textwidth]{Chapitre 2 - Accélération et vitesse dans le cas d’un mouvement rectiligne/images/doc5.png}
\end{minipage}%
