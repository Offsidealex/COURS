...
\begin{center}
    ...
    \begin{tabular}{|p{6cm}|C{2cm}|C{2cm}|C{2cm}|}
      ...
      Forme à utiliser & $P$ & $F$ & $S$ \\
         \hline
         \textcolor{red}{$F = P \times S$} & 1,013 bar  & \textcolor{red}{$5{,}065 \times 10^4$ N} & 0,5 $m^2$\\
         \hline
         \textcolor{red}{$P = \dfrac{F}{S}$} & \textcolor{red}{$7{,}8 \times 10^4$ Pa} & 50 N & 6,4 $cm^2$ \\
         \hline
         \textcolor{red}{$S = \dfrac{F}{P}$} & $2 \times 10^5$ Pa & 50 N & \textcolor{red}{$2{,}5 \times 10^{-4}$ $m^2$} \\
         \hline
