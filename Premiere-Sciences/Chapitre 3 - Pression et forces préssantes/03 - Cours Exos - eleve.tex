...
\hfill
\begin{minipage}{.23\textwidth}%
\fbox{\includegraphics[width=\textwidth]{images/cours1.png}}
\end{minipage}%
...
\fbox{\includegraphics[width=\textwidth]{images/cours2.png}}
\end{minipage}%
\hfill
\begin{minipage}{.38\textwidth}%
\fbox{\includegraphics[width=\textwidth]{images/cours3.png}}
\end{minipage}%
...
\begin{center}
    ...
    \begin{tabular}{|C{0.5cm} p{5.5cm}|C{3cm}|C{3cm}|C{3cm}|}
      ...
      \ding{203}&Quelle est la relation entre la pression et la force pressante  & $\Box $ ~~$p=F \times S$ & $\Box $ ~~$F=p \times S$  & $\Box $ ~~ $F=\dfrac{S}{P}$ \\
         ...
         \hline
         \ding{206}& La pression atmosphérique est environ égale à  &$\Box $ ~~ $1\times 10^5$~Pa& $\Box $ $1\times 10^{-5} $~Pa& $\Box $ ~~ e$1\times 10^5$~Bar \\
         \hline
