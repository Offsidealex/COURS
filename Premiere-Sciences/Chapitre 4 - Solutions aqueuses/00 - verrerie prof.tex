...
\hrule
\vspace{3mm}
\center \LARGE{Document 3 : Identification de la verrerie de laboratoire}\\[0,6cm]
\hrule
\normalsize
\vfill 
...
& 
\includegraphics[height=2.5cm]{../solution aqueuses/images/verre.eps} \\[0.2cm]
...
\hline
% Ligne 2
\raisebox{-23mm}{\includegraphics[height=3.5cm]{../solution aqueuses/images/fiole.eps}}
& 
\multicolumn{2}{|c|}{\raisebox{-2.7cm}{\psset{unit=0.5cm} \pstChauffageBallon[glassType=ballon,recuperationGaz,tubeRecourbeCourt]}}
& 
\raisebox{-18mm}{\includegraphics[height=3.5cm]{../solution aqueuses/images/propipette.eps}}
& 
...
\hline
% Ligne 3
\raisebox{-14mm}{\includegraphics[height=3cm]{../solution aqueuses/images/chauffe.eps}}
& 
\raisebox{-1.2cm}{\psset{unit=0.5cm}
\pstDosage[glassType=erlen,burette=false]}
& 
\multirow{2}{*}{\raisebox{100mm}{\includegraphics[height=6.3cm]{../solution aqueuses/images/burette.eps}}}
& 
\multirow{2}{*}{\includegraphics[height=6.3cm]{../solution aqueuses/images/pipette.eps}}
& 
\multirow{2}{*}{\includegraphics[height=6.3cm]{../solution aqueuses/images/refrigerant.eps}}
\\[1cm]
