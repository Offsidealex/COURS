...
\begin{center}
 \LARGE{TP4 - Dosage colorimétrique du vinaigre    }
\end{center}
...
\begin{center}
\fbox{\includegraphics[scale=0.5]{Chapitre 4 - Solutions aqueuses/images/Dosage_vinaigre.png}}
...
\textbf{Remettre dans l'ordre les différentes étapes de la dilution. Vous préciserez sur le schéma le volume de pipette jaugée et celui de la fiole jaugée. }
\begin{minipage}{.65\textwidth}%
\fbox{\includegraphics[scale=0.6]{Chapitre 4 - Solutions aqueuses/images/Dilutionsansnumeros.png}}
\end{minipage}%
\hfill 
...
Appeler M. Ruiz \\ pour vérification \\ de votre protocole. \\[3mm]
Puis réaliser la dilution à l'aide de votre protocole validé}
\end{minipage}
}}
\end{minipage}%
...
\textbf{\ding{202}  Dosage rapide} \\

\begin{enumerate}
    \item Vérifier que le robinet d'arrêt de la burette est fermé.
...
\end{itemize}
 ...
 \defbox{\fbox{
\begin{minipage}{14cm}{
\textbf{Appel n\degree 4}\\Appeler M. Ruiz pour lui faire vérifier le rangement du poste de travail. }
\end{minipage}
}}
...
avec \begin{itemize}
    \item \chemform{C_A} : concentration en acide acétique (mol/L) \textbf{à calculer }
    \item  \chemform{V_A} : volume, en L, de vinaigre utilisé lors du dosage. 
    \item  \chemform{V_E} : volume équivalent en L d'hydroxyde de sodium. 
    \item \chemform{C_B} : concentration en soude NaOH. 
\end{itemize}
\textbf{Rappel : On a dilué 10 fois. }
...
\begin{itemize}
    \item Calculer, en g/mol, la masse molaire \chemform{M(CH_3COOH)}. \\[3mm]
     \dotfill 


\item Calculer la masse d'acide acétique de formule \chemform{CH_3COOH} présente dans 100 g de vinaigre. 

\cadreblanc{35}

\vfill 

\item Relever le degré d'acidité porté sur l’étiquette de la bouteille de vinaigre ? Le résultat expérimental
