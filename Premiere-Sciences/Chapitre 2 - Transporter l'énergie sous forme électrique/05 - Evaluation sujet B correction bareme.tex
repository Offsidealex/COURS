...
\setcounter{page}{1}\fancyfoot[C]{BARÈME}
...
\hline
\ding{202} & Unité de l'intensité efficace : Ampère & 1 pt \\
\hline
\ding{203} & Formule de la loi d'Ohm : $I=\dfrac{U}{R}$ & 1 pt \\
\hline
\ding{204} & Nature du transformateur si m<1 : abaisseur & 1 pt \\
\hline
\ding{205} & Formule de $P_j$ : $P_j=R \times I^2$ & 1 pt \\
\hline
\ding{206} & Formule de R : $R=\dfrac{U^2}{P_j}$ & 1 pt \\
\hline
\end{tabularx}

\vspace{3mm}

\section*{\ding{203} Exercice 2 : Transformateur de portail \hfill \textbf{7 points}}
...
\hline
\textbf{2.1} & Lecture : 2,5 div (0,5) + Calcul : $2,5 \times 10$ (0,5) + $U_{max} = 25$ V (0,5) & \textbf{1,5} \\
\hline
\textbf{2.2} & Formule : $U_{eff} = \dfrac{U_{max}}{\sqrt{2}}$ (0,5) + AN (0,5) + $U_{eff} \approx 18$ V (0,5) & \textbf{1,5} \\
\hline
\textbf{2.3} & Formule : $m = \dfrac{U_{2eff}}{U_{1eff}}$ (0,5) + AN (0,5) + $m \approx 0,08$ (0,5) & \textbf{1,5} \\
\hline
...
\hline
\textbf{3.1} & Lecture voie 1 : $U_{1max} = 580$ V (0,75) + voie 2 : $U_{2max} = 40$ V (0,75) & \textbf{1,5} \\
\hline
\textbf{3.2} & Formule $U_{eff} = \dfrac{U_{max}}{\sqrt{2}}$ (0,5) + $U_{1eff} = 411,5$ V (0,75) + $U_{2eff} = 29,0$ V (0,75) & \textbf{2} \\
\hline
...
\textbf{Réponse : 7 enfants (4 garçons et 3 filles)} ~~~ \textbf{Barème :} Réponse juste avec démonstration : +1 pt • Réponse juste seule : +0,5 pt
\end{tcolorbox}
