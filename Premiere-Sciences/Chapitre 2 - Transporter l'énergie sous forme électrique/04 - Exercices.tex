...
\begin{center}
    ...
    \begin{tabular}{|p{6cm}|C{3cm}|C{3cm}|C{3cm}|}
      ...
      \ding{203}La puissance électrique $P_j$ dissipée par effet Joule se calcule avec ...  & $\Box $ ~~$P_j=R \times I$ & $\Box $ ~~$P_j=R \times I^2$  & $\Box $ ~~ $P_j=R^2 \times I$ \\
         ...
         \hline 
         \ding{210} Le symbole électrique du transformateur est   &$\Box ~~ $ \includegraphics[scale=0.55]{images/QCM1.png}   &$\Box ~~ $ \includegraphics[scale=0.75]{images/QCM2.png}     &$\Box ~~ $ \includegraphics[scale=0.65]{images/QCM3.png}   \\
         \hline
