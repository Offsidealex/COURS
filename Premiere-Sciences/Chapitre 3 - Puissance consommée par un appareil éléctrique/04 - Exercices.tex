...
\begin{center}
    ...
    \begin{tabular}{|C{0.5cm} p{5.5cm}|C{3cm}|C{3cm}|C{3cm}|}
       ...
       & $\Box $ ~~sont en phase & $\Box $ ~~sont déphasées & $\Box $ ~~ont le même déphasage\\
         ...
         &
       \includegraphics[scale=0.2]{Chapitre 3 - Puissance consommée par un appareil éléctrique/images/qcm1.png}
       & &  & \\
      ...
      \ding{204}&$\varphi$ représente & $\Box $ ~~le décalage temporel entre $u(t)$ et $i(t)$ & $\Box $ ~~le facteur de puissance  & $\Box $~~le déphasage entre $u(t)$ et $i(t)$ \\
         ...
         & \includegraphics[scale=0.2]{Chapitre 3 - Puissance consommée par un appareil éléctrique/images/qcm22.png} & & & \\
...
\hfill
\begin{minipage}{.46\textwidth}%
\includegraphics[width=\textwidth]{Chapitre 3 - Puissance consommée par un appareil éléctrique/images/exo3.png}
