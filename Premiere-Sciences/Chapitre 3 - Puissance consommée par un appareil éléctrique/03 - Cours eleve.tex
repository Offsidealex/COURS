...
\fbox{\includegraphics[width=\textwidth]{Chapitre 3 - Puissance consommée par un appareil éléctrique/images/cours1.png}}
\end{minipage}%
...
\hfill
\begin{minipage}{.3\textwidth}%
\fbox{\includegraphics[width=\textwidth]{Chapitre 3 - Puissance consommée par un appareil éléctrique/images/cours32.png}}
\end{minipage}%
\end{itemize}
\vfill 
...
\hfill
\begin{minipage}{.3\textwidth}%
\fbox{\includegraphics[width=\textwidth]{Chapitre 3 - Puissance consommée par un appareil éléctrique/images/cours33.png}}
\end{minipage}%
\vfill 
...
\includegraphics[scale=0.5]{Chapitre 3 - Puissance consommée par un appareil éléctrique/images/cours341.png}
