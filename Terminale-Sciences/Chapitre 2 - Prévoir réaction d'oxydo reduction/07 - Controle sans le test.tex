...
\textbf{Exercice 1 : QCM}~~Parmi les trois propositions, entourer la bonne réponse. 
\begin{center}
...
\begin{tabular}{|>{\columncolor{Peach}}m{4mm}|p{4.5cm}||m{3.5cm}|m{3.5cm}|m{3.5cm}|}
    ...
    \ding{203} & Dans quel cas l'ion en solution ne se dépose-t-il pas sur la lame métallique  & ~~~~~~~~\raisebox{-.7\height}{\includegraphics[scale=1]{images/QCm21.png}}& ~~~~~~~~\raisebox{-.7\height}{\includegraphics[scale=1.05]{images/QCm22.png}} & ~~~~~~~~\raisebox{-.7\height}{\includegraphics[scale=1]{images/QCm23.png}} \\
    \hline
...
\textbf{Exercice 2 :} Dans un bêcher on plonge un métal dans une solution ionique métallique. 
...
\textbf{Exercice 3 : Étude documentaire } \\

\includegraphics[scale=0.56]{images/Document corrosion.png}

\textbf{\'A l'aide du document ci-dessus, répondez au questions suivantes : }

\begin{enumerate}
    \item Quel type de tôles utilise-t-on pour la fabrication des carrosseries ? \\
    
    \dotfill 
  
    \dotfill

    \item Pourquoi la couche de zinc peut-elle empêcher la corrosion du fer ? \\

    \dotfill 

    \item Quels sont les différentes opérations subies par une carrosserie avant d'être peintes ? \\

    \dotfill 

    \item Quel est le rôle de la peinture dans la protection de la carrosserie ? \\
...
\dotfill\fcolorbox{black}{gray!10!}{ \textbf {ENIGMES BONUS (2 $\times$ 0,5 pt)}}\dotfill
\begin{multicols}{2}
Il y a dans une cour que des lapins et des poules. On dénombre 128 têtes et 438 pattes. Combien y a-t-il de poules ?

\cadre{30}
\columnbreak

Un croissant et un chewing-gum coûtent 2,10 \euro{}. Le croissant coute 2 \euro{} de plus que le chewing-gum. Combien coûte le chewing-gum? 
\cadre{27}
